...
class SummarizationModel(object):
  ...
  def _add_placeholders(self):
    ...
    self._rel_scores_batch = tf.placeholder(tf.float32, [hps.batch_size, None], name='rel_scores_batch')
  ...
  def _add_decoder(self, inputs):
    ...
    outputs, out_state, attn_dists, p_gens, coverage = attention_decoder(inputs, self._dec_in_state, self._enc_states, self._rel_scores_batch, cell, initial_state_attention=(hps.mode=="decode"), pointer_gen=hps.pointer_gen, use_coverage=hps.coverage, prev_coverage=prev_coverage)
